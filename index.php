...
<body>
    <div class="px-5 container text-center">
        <h1 class="text-center">TOKO SUKAMAJU JAYA ABADI MANTAP</h1>
        <form action="" class="" method="post">
            <div class="row ">
                ...
                <input type="number" placeholder="masukan harga barang" name="hargaBarang" required class="form-control"
                    class="">
            </div>
            <div class="mt-2 row">
